...
const CardDetails = () => {
  ...
  <div className="z-50 flex flex-col justify-center text-white w-full h-screen">
    ...
    <div className="mt-6 flex text-white mx-auto">
      <a href="#">
        <svg fill="currentColor" className="cursor-pointer h-6 mr-2" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" xmlSpace="preserve" xmlns:serif="http://www.serif.com/" style={{fillRule: 'evenodd', clipRule: 'evenodd', strokeLinejoin: 'round', strokeMiterlimit: 2}}>
